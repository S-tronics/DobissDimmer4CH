 ...
 *
 ********************************************************************/
BOOLEAN ECANSendMessage( unsigned long id,
                     BYTE *data,
                     BYTE dataLen,
                     ECAN_TX_MSG_FLAGS msgFlags);
 ...
 *
 ********************************************************************/
BOOLEAN ECANReceiveMessage( unsigned long* id,
                        BYTE *Data,
                        BYTE *DataLen,
                        ECAN_RX_MSG_FLAGS *MsgFlags);
 ...
 */
    ...
    #define PIR3_RXBnIF             PIR5bits.RXB1IF
    ...
    #define RXFCON1_RXF8EN          RXF8EN
    #define RXFCON1_RXF9EN          RXF9EN
    ...
    //static volatile bit        RXBODBEN   @ ((unsigned)&RXB0CON*8)+2;
